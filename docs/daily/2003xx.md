...
### 오늘 한 일 
1. 백준 알고리즘 문제 풀이
    - [10828 스택](https://github.com/linear14/algorithm/blob/master/src/algorithm_beakjoon/10828_%EC%8A%A4%ED%83%9D.kt)
    - [10773 제로](https://github.com/linear14/algorithm/blob/master/src/algorithm_beakjoon/10773_%EC%A0%9C%EB%A1%9C.kt)
    - [9012 괄호](https://github.com/linear14/algorithm/blob/master/src/algorithm_beakjoon/9012_%EA%B4%84%ED%98%B8.kt)
    - [4949 균형잡힌 세상](https://github.com/linear14/algorithm/blob/master/src/algorithm_beakjoon/4949_%EA%B7%A0%ED%98%95%EC%9E%A1%ED%9E%8C%20%EC%84%B8%EC%83%81.kt)
1. 알고리즘 학습
    - 스택
    - 큐
    
### 기록
- 알고리즘 학습에 꽤나 많은 시간이 사용되는 것 같습니다.  
재미있어서 공부를 하고는 있지만, 알고리즘 역시 개발을 할 줄 알아야 써먹을 곳이 있다는 사실을 다시금 인지 할 필요가 있어 보였습니다.  

- 개강을 핑계로 코딩 공부에 소홀해지는 것 같습니다.  
물론 시간 투자야 방학에 비해 적을 수 밖에 없는 것이 맞긴 하지만,  
적어도 공부 할 때는 최대한으로 집중을 해서 최대로 몰두를 할 수 있도록 마음가짐을 다잡아야 하겠습니다.  

- 스터디 코틀린 공부 계획을 설정했습니다.  
시험 기간을 제외한 총 7주간 꼼꼼히 공부를 할 생각입니다.  
목표 기간은 3월 31일 ~ 5월 31일 2개월입니다.

# 200331_TUE
### 오늘 한 일 
1. 백준 알고리즘 문제 풀이
    - [2577 숫자의 개수](https://github.com/linear14/algorithm/blob/efaba874fece9bd0ea5704acfb4e31b2eb50fce5/src/algorithm_beakjoon/2577_%EC%88%AB%EC%9E%90%EC%9D%98%20%EA%B0%9C%EC%88%98.kt)
    - [8958 OX퀴즈](https://github.com/linear14/algorithm/blob/efaba874fece9bd0ea5704acfb4e31b2eb50fce5/src/algorithm_beakjoon/8958_OX%ED%80%B4%EC%A6%88.kt)
    - [4673 셀프 넘버](https://github.com/linear14/algorithm/blob/efaba874fece9bd0ea5704acfb4e31b2eb50fce5/src/algorithm_beakjoon/4673_%EC%85%80%ED%94%84%20%EB%84%98%EB%B2%84.kt)
...
1. 클론 앱 구현 (당근 마켓)
    - 레이아웃 구성
    - [핵심기능 : EditText 글자 입력 리스너 적용](https://github.com/linear14/CarrotMarket/commit/c3f38a9d4815c40a5e0966b7d74cd6d455a53e00)
1. Kotlin In Action 학습
    - 함수와 변수
    - 문자열 템플릿
    - 프로퍼티
    - 커스텀 접근자 (Getter Setter)
    - 디렉터리와 패키지
    - enum 클래스
    - enum 클래스를 when으로 다루기
    
### 기록
- 트라비 포켓 마무리를 하는 것이 좋겠다는 판단을 했습니다.  
코드가 엉망이긴 하지만, 뭐라도 하나 제대로 끝내는 것이 중요하기 때문입니다.

- 코틀린 언어 복습을 시작했습니다.  
또한 Tistory블로그를 만들었습니다. 앞으로의 기록은 Tistory에서 할 생각입니다.  
Github에서도 Tistory링크를 걸어두겠습니다.

- Firebase를 활용하는 연습이 필요했기 때문에, 높은 수준의 클론앱을 구현하기로 결정했습니다.
